...
local win = library:AddWindow("Name Hub")
...
Main1:AddToggle("YaY",Config,function(value)
    Config = value
end)

local aya = Main1:AddDropdown("YaY22",{"SddS","SSsad","SDAs"},function(value)
    WoW = value
end)

Main1:AddButton("YaY2",function()
    aya:Clear()
